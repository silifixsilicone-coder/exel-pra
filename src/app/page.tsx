...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-emerald-500 selection:text-slate-950">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight">Path Excel</span>
          </Link>

          {/* Nav Items */}
          <nav className="hidden lg:flex items-center gap-6 text-xs font-semibold">
            <Link href="/learn" className="hover:text-emerald-500 transition">Learn</Link>
            <Link href="/practice" className="hover:text-emerald-500 transition">Practice</Link>
            <Link href="/formula-library" className="hover:text-emerald-500 transition">Formula Library</Link>
            <Link href="/shortcut-lab" className="hover:text-emerald-500 transition">Shortcut Lab</Link>
            <Link href="/job" className="hover:text-emerald-500 transition">Job Mode</Link>
            <Link href="/interview-lab" className="hover:text-emerald-500 transition">Interview Lab</Link>
            <Link href="/exam" className="hover:text-emerald-500 transition">Exams</Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="p-2 bg-slate-900/10 hover:bg-slate-900/20 border border-slate-700/10 rounded-xl transition hidden sm:inline-block"
            >
      ...
      <section className="pt-32 pb-20 relative overflow-hidden bg-slate-950">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 text-left">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-full text-[10px] font-bold text-emerald-400 tracking-wider uppercase select-none">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <Link 
                href="/practice"
                className="px-6 py-3 bg-slate-900 border border-slate-800 hover:bg-slate-800 text-slate-300 rounded-xl text-sm font-bold transition active:scale-95"
              >
                Practice Now
              </Link>
            </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-2xl relative overflow-hidden transition hover:scale-[1.02] duration-300">
              ...
              {/* Grid Mockup */}
              <div className="bg-slate-950 border border-slate-850 rounded-xl p-3 font-mono text-[10px] space-y-2">
                <div className="flex gap-1.5 items-center p-1 bg-slate-900 rounded border border-slate-800">
                  <span className="text-emerald-500 font-bold px-1.5 bg-slate-950 rounded">A1</span>
                  <span className="text-slate-500 font-serif italic">fx</span>
                  <span className="text-emerald-450 font-bold font-mono text-[9px]">=VLOOKUP(D2, A1:B10, 2, FALSE)</span>
                </div>

                <div className="grid grid-cols-4 gap-1.5 text-center text-slate-400 font-semibold border-b border-slate-800 pb-1.5 select-none">
                  <span>ID</span>
                  <span>Product</span>
                  <span>Price</span>
                  <span>Status</span>
                ...
                {[
                  ...
                  <div key={idx} className="grid grid-cols-4 gap-1.5 text-center text-slate-350 py-1 border-b border-slate-900 last:border-0 hover:bg-slate-900/40 rounded transition">
                    <span>{row[0]}</span>
                    <span className="text-left pl-2 text-slate-200">{row[1]}</span>
                    <span>{row[2]}</span>
                    <span className="text-emerald-455 font-bold">{row[3]}</span>
                  </div>
                ))}
              </div>

              {/* Floating Formula Card */}
              <div className="absolute bottom-6 left-6 bg-slate-900/90 border border-emerald-500/30 p-3 rounded-xl shadow-xl flex items-center gap-2 animate-bounce">
                <Award className="w-4 h-4 text-emerald-400" />
                <span className="text-[10px] text-slate-100 font-bold">Formula Evaluated Success!</span>
              </div>
            </div>
          </div>
      ...
      <section className="bg-slate-950/40 border-y border-slate-900 py-8 select-none">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 flex flex-wrap justify-center gap-4 text-center">
          {[
            ...
            <span key={stat} className="px-3.5 py-1 bg-slate-900 border border-slate-850 text-slate-300 rounded-full text-xs font-semibold">
              {stat}
            </span>
          ))}
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5 bg-slate-900 border border-slate-800 p-5 rounded-2xl shadow-xl space-y-4">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                ...
                <span className="px-2 py-0.5 text-[9px] font-bold bg-emerald-950/20 text-emerald-450 rounded border border-emerald-900/50">
                  Beginner • 30s
                </span>
              </div>

              <div className="space-y-2 text-xs">
                <p><strong className="text-slate-200">Scenario:</strong> A shop owner wants today's total sales calculated.</p>
                <div className="bg-slate-950 border border-slate-850 p-3 rounded-xl">
                  <strong className="text-emerald-400 block mb-0.5">Task:</strong>
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-xl space-y-3">
                <div className="flex items-center gap-2 p-1.5 bg-slate-950 border border-slate-850 rounded-xl text-xs font-mono">
                  <div className="w-10 text-center font-bold text-emerald-500 bg-slate-900 py-1 rounded">B6</div>
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent text-emerald-400 font-bold focus:outline-none placeholder-slate-700"
                  />
                </div>
                ...
                <div className="overflow-x-auto border border-slate-800 rounded-xl bg-slate-950 font-mono text-xs">
                  <table className="w-full border-collapse">
                    <thead>
                      ...
                      <tr className="bg-slate-900/40 border-b border-slate-800 text-slate-350">
                        <th className="p-2 border-r border-slate-800 select-none text-slate-500 w-10 text-center font-bold">1</th>
                        <th className="p-2 border-r border-slate-800 text-center">Item</th>
                        <th className="p-2 border-r border-slate-800 text-center">Sales</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ...
                        return (
                          <tr key={idx} className="border-b border-slate-850">
                            <td className="p-2 border-r border-slate-800 text-slate-500 text-center font-bold select-none">{rowNum}</td>
                            <td className="p-2 border-r border-slate-850 text-center text-slate-300">{row[0]}</td>
                            <td className={`p-2 border-r border-slate-850 text-center text-slate-300 ${isTarget ? 'bg-slate-900 font-bold text-emerald-400 ring-2 ring-emerald-500 ring-inset' : ''}`}>
                              {isTarget ? (
                                <input
                                  type="text"
                                  value={demoInput}
                ...
                <div className="flex gap-2 justify-end">
                  <button
                    ...
                    className="px-4 py-2 bg-slate-850 hover:bg-slate-800 text-slate-300 border border-slate-700 rounded-xl text-xs font-semibold transition"
                  >
                    Reset
                  </button>
                  <button
                    ...
                    <div className="space-y-1 text-left">
                      ...
                      {demoFeedback.isCorrect && (
                        <div className="flex gap-2 pt-2">
                          <Link href="/dashboard" className="px-3 py-1 bg-emerald-500 text-slate-950 font-bold rounded text-[10px] transition">
                            Continue Learning
                          </Link>
                          <Link href="/practice" className="px-3 py-1 bg-slate-950 border border-slate-850 text-slate-300 rounded text-[10px] transition">
                            Practice More
                          </Link>
                        </div>
                      )}
            ...
            {[
              ...
              return (
                <Link
                  key={idx}
                  href={f.href}
                  className="bg-slate-900 border border-slate-800 hover:border-slate-700 p-6 rounded-2xl flex flex-col justify-between gap-6 hover:shadow-xl transition"
                >
                  ...
                  <span className="flex items-center gap-1 text-[11px] font-bold text-emerald-455">
                    Start Environment
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4 text-center">
            {[
              ...
              <div 
                key={idx} 
                className="bg-slate-900 border border-slate-800/80 p-5 rounded-2xl space-y-3 shadow-md hover:scale-105 transition duration-300"
              >
                <span className="w-6 h-6 rounded-full bg-emerald-500/10 text-emerald-450 border border-emerald-500/20 text-xs font-bold font-mono inline-flex items-center justify-center">
                  {s.step}
                </span>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              >
                <div>
                  <h4 className="text-xs font-bold text-slate-100">{module}</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
            {[
              ...
              <div 
                key={idx}
                className="bg-slate-900 border border-slate-800/80 p-4 rounded-2xl text-center space-y-2 shadow-sm"
              >
                <div className="w-8 h-8 rounded-full bg-emerald-500/10 text-emerald-400 flex items-center justify-center mx-auto text-xs font-bold">
                  {idx + 1}
                </div>
                <h4 className="text-[10px] font-bold text-slate-200">{p}</h4>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 space-y-12">
          ...
          <div className="overflow-x-auto border border-slate-800 rounded-2xl bg-slate-900 max-w-2xl mx-auto shadow-lg">
            <table className="w-full border-collapse text-left text-xs">
              <thead>
                <tr className="bg-slate-950 border-b border-slate-800 font-bold text-slate-200">
              ...
              <tbody className="divide-y divide-slate-850 font-medium">
                {[
                  ...
                  <tr key={idx} className="hover:bg-slate-900/30">
                    <td className="p-4 text-slate-350">{row[0]}</td>
      ...
      <section className="py-16 bg-slate-950/40 border-y border-slate-900 select-none">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div 
                key={idx}
                className="bg-slate-900 border border-slate-800 p-6 rounded-2xl shadow-md space-y-4 hover:shadow-lg transition duration-200"
              >
      ...
      <section className="py-20 bg-slate-950/40 border-y border-slate-900">
        <div className="max-w-3xl mx-auto px-4 md:px-6 space-y-10">
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-450 text-xs">Everything you need to know about the platform.</p>
          </div>
            ...
            {faqData.map((faq, idx) => (
              ...
              >
                <button
                  ...
                  className="w-full px-5 py-4 text-left text-xs font-semibold text-slate-200 hover:text-white flex justify-between items-center transition"
                >
                  <span>{faq.q}</span>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-5 gap-8 border-b border-slate-900 pb-10">
          <div className="col-span-2 space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-md bg-emerald-500 flex items-center justify-center shadow">
          ...
          <div className="space-y-3">
            <h4 className="font-bold text-slate-300 uppercase tracking-wider text-[10px]">Quick Links</h4>
            <ul className="space-y-2 font-sans">
              <li><Link href="/learn" className="hover:text-slate-350 transition">Lessons</Link></li>
              <li><Link href="/practice" className="hover:text-slate-350 transition">Spreadsheet Practice</Link></li>
              <li><Link href="/formula-library" className="hover:text-slate-350 transition">Formula Reference</Link></li>
              <li><Link href="/shortcut-lab" className="hover:text-slate-350 transition">Shortcut Lab</Link></li>
            </ul>
          </div>

          <div className="space-y-3">
            <h4 className="font-bold text-slate-300 uppercase tracking-wider text-[10px]">Resources</h4>
            <ul className="space-y-2 font-sans">
              <li><Link href="/job" className="hover:text-slate-350 transition">Job Mode</Link></li>
              <li><Link href="/interview-lab" className="hover:text-slate-350 transition">Interview assessments</Link></li>
              <li><Link href="/exam" className="hover:text-slate-350 transition">Corporate Exams</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 font-sans text-slate-500">
              <li><span className="hover:text-slate-350 transition cursor-pointer">Privacy Policy</span></li>
              <li><span className="hover:text-slate-350 transition cursor-pointer">Terms of Service</span></li>
            </ul>
          </div>
        </div>

        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 font-mono text-[10px]">
          <span>© {new Date().getFullYear()} Path Excel. All rights reserved.</span>
          <span className="text-slate-650">Handcrafted for Professional Office Readiness.</span>
        </div>
      </footer>
